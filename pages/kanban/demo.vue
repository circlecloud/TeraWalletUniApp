<template>
	<view class="qiun-columns">
		...
		<view class="qiun-padding"><view class="qiun-tip" @tap="changeData()">修改柱状图数据</view></view>
		...
		<view class="qiun-bg-white qiun-title-bar qiun-common-mt"><view class="qiun-title-dot-light">K线图（蜡烛图）</view></view>
		...
		<view class="qiun-charts-rotate"><canvas canvas-id="canvasLineB" id="canvasLineB" class="charts-rotate" @touchstart="touchLineB"></canvas></view>
