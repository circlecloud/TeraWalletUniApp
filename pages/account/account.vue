<template>
	<view>
		...
		<uni-list>
			<uni-list-item show-arrow: false :show-badge="account.Latest.Amount > 0" :badge-type="getBadgeTypeByTime(account.Latest)"
			 :badge-text="getBadgeTextByTime(account.Latest)" :title="account.Num" :note="formatNote(account)" :key="key" v-for="(account, key) in accounts" />
		</uni-list>
	</view>
</template>
